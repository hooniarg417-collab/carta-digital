...
export default function MenuClient() {
  ...
  const [platoDelDiaCfg, setPlatoDelDiaCfg] = useState<PlatoDelDiaConfig | null>(
    null
  );
  ...
  const [accionLoading, setAccionLoading] = useState<null | "mozo" | "cuenta">(
    null
  );
        ...
        <div className="glass-panel rounded-3xl px-3 py-3 sm:px-4 sm:py-4 space-y-4">
          <div className="flex items-center justify-between gap-3 text-xs text-[var(--color-text-muted)]">
            ...
            {loading ? (
              ...
              <span>{categorias.length} secciones</span>
            )}
          </div>
